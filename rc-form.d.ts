declare module 'rc-form' {
    ...
    export interface WrappedFormMethods {
      ...
      getFieldDecorator(name: string, option?: GetFieldPropsOptions): (node: ReactNode) => ReactNode
    ...
    export type WrappedFormClass<P> = FunctionComponent<P> & WrappedFormMethods
  
    export type Decorate<P> = (WrappedComponent: FunctionComponent<P>) => WrappedFormClass<P>
